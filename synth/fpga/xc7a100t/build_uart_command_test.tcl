...
set output_dir [file join $repo_root build fpga xc7a100t uart-command-test]
set top_name openrv64_myd_j7a100t_uart_command_test_top
...
read_verilog -sv [file join $script_dir uart_command.sv]
read_verilog -sv [file join $script_dir ${top_name}.sv]
read_xdc [file join $script_dir myd_j7a100t.xdc]
read_xdc [file join $script_dir uart_command_test.xdc]
...
puts "OPENRV64 MYD-J7A100T UART COMMAND BITSTREAM BUILD PASS"
