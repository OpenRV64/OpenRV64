...
//
// MYD-J7A100T clock/reset/UART transmit test.

`timescale 1ns/1ps

module openrv64_myd_j7a100t_clock_uart_test_top (
    ...
    // Asynchronous assertion and synchronous deassertion into the board-clock
    // domain.  Explicit initialization covers configuration while rst_n is
    // already high.
    ...
    // The receive pin is intentionally unused: the expected output is
    // generated from the board clock, not from terminal local echo or an RX
    // loopback path.
