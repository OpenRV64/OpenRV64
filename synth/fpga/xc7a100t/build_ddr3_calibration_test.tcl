...
set output_dir [file join $repo_root build fpga xc7a100t ddr3-calibration]
...
set top_name openrv64_myd_j7a100t_ddr3_calibration_top
...
create_project -force ddr3_calibration $project_dir -part $part_name
set_param general.maxThreads 8

# Recreate the supplied MIG for the actual -2 board device.  The source
# project was generated for -1; changing only TargetFPGA avoids importing a
# locked, wrong-speed-grade XCI or a stale vendor checkpoint.
...
add_files -norecurse [list \
    ...
    [file join $script_dir ddr3_uart_status.sv] \
...
set run_bit [file join $project_dir ddr3_calibration.runs impl_1 ${top_name}.bit]
...
puts "OPENRV64 MYD-J7A100T DDR3 CALIBRATION BITSTREAM BUILD PASS"
