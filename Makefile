...
CORE_3P_MAGIC_VERILATOR_DIR := \
	build/verilator/core-3p-magic-bp$(CORE_3P_MAGIC_BP_TYPE)-mode$(CORE_3P_MAGIC_MODE)-confidence$(CORE_3P_MAGIC_CONFIDENCE_GATE)-cf$(CORE_3P_MAGIC_COMPLETION_FORWARD_MASK)-bf$(CORE_3P_MAGIC_BRANCH_FORWARD_MASK)-ff$(CORE_3P_MAGIC_FULL_FORWARDING)-rw$(CORE_3P_MAGIC_RELAX_WAW)-rh$(CORE_3P_MAGIC_RELAX_HAZARDS)
...
sim-fetch-3w: $(FETCH_3W_SIM_BUILD) $(FETCH_3W_SECTOR_SIM_BUILD) \
