...
`ifndef SYNTHESIS
    openrv64_l2_debug_stub #(
        ...
        .coherence_probe_start_fire(coherence_probe_start_fire),
        .coherence_probe_start_target(
            mshr_probe_target_q[probe_candidate_mshr_r]),
        .probe_valid_o(probe_valid_o),
        .probe_ready_i(probe_ready_i),
        .probe_resp_valid_i(probe_resp_valid_i),
        .probe_resp_ready_o(probe_resp_ready_o),
        .probe_resp_error_i(probe_resp_error_i),
        ...
        .lookup_stall(lookup_valid_q && !lookup_dispatch_r),
        .mshr_free_found_r(mshr_free_found_r),
