...
// ICX request/L2 datapath; it provides the directory and probe contract on
// which that datapath will be built.
`define OPENRV64_ICX_COHERENT_FIXED_MODULE openrv64_icx_4h_control
`define OPENRV64_ICX_COHERENT_FIXED_HARTS 4
...
// progress resources.
module openrv64_icx_4h_l1d_probe_cluster #(
    ...
    input  wire [4*`OPENRV64_ICX_PROBE_ID_WIDTH-1:0] probe_id_i,
    input  wire [4*`OPENRV64_ICX_PROBE_CMD_WIDTH-1:0]
                                               probe_command_i,
    input  wire [4*`OPENRV64_ICX_PROBE_CACHE_WIDTH-1:0]
                                               probe_cache_mask_i,
    input  wire [4*64-1:0]              probe_line_addr_i,

    output wire [3:0]                   probe_resp_valid_o,
    input  wire [3:0]                   probe_resp_ready_i,
    output wire [4*`OPENRV64_ICX_PROBE_ID_WIDTH-1:0]
                                               probe_resp_id_o,
    output wire [4*`OPENRV64_ICX_PROBE_RESP_WIDTH-1:0]
                                               probe_resp_kind_o,
    output wire [4*`OPENRV64_ICX_LINE_DATA_WIDTH-1:0]
                                               probe_resp_data_o,
    ...
    generate
        for (endpoint = 0; endpoint < 4;
            ...
            openrv64_icx_l1d_probe_endpoint #(
                ...
                .probe_id_i(
                    probe_id_i[
                        endpoint*`OPENRV64_ICX_PROBE_ID_WIDTH +:
                        `OPENRV64_ICX_PROBE_ID_WIDTH]),
                .probe_command_i(
                    probe_command_i[
                        endpoint*`OPENRV64_ICX_PROBE_CMD_WIDTH +:
                        `OPENRV64_ICX_PROBE_CMD_WIDTH]),
                .probe_cache_mask_i(
                    probe_cache_mask_i[
                        endpoint*`OPENRV64_ICX_PROBE_CACHE_WIDTH +:
                ...
                .probe_resp_kind_o(
                    probe_resp_kind_o[
                        endpoint*`OPENRV64_ICX_PROBE_RESP_WIDTH +:
                        `OPENRV64_ICX_PROBE_RESP_WIDTH]),
                .probe_resp_data_o(
                    probe_resp_data_o[
                        endpoint*`OPENRV64_ICX_LINE_DATA_WIDTH +:
