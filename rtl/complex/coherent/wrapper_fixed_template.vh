...
module `OPENRV64_ICX_COHERENT_FIXED_MODULE #(
    ...
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS-1:0]
    ...
    input  wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS-1:0]
    ...
    input  wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS-1:0]
                                               inv_target_harts_i,
    input  wire [`OPENRV64_ICX_PROBE_ID_WIDTH-1:0] inv_probe_id_i,
    ...
    input  wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS-1:0]
                                               probe_ready_i,
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS*
                 `OPENRV64_ICX_PROBE_ID_WIDTH-1:0] probe_id_o,
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS*
                 `OPENRV64_ICX_PROBE_CMD_WIDTH-1:0] probe_command_o,
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS*
                 `OPENRV64_ICX_PROBE_CACHE_WIDTH-1:0] probe_cache_mask_o,
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS*64-1:0]
                                               probe_line_addr_o,
    ...
    output wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS-1:0]
                                               probe_ack_ready_o,
    input  wire [`OPENRV64_ICX_COHERENT_FIXED_HARTS*
                 `OPENRV64_ICX_PROBE_ID_WIDTH-1:0] probe_ack_id_i,

    input  wire                         protocol_error_clear_i,
    output wire                         protocol_error_o
);

    openrv64_icx_coherent_control #(
        .NUM_HARTS(`OPENRV64_ICX_COHERENT_FIXED_HARTS),
