...
module openrv64_fetch_debug_stub #(
    ...
    input wire ras_req_fire /* verilator public_flat_rd */,
    input wire pair_req_fire /* verilator public_flat_rd */,
    input wire ras_line_pending_q /* verilator public_flat_rd */,
    input wire [`RV64_XLEN-1:0] ras_line_addr_q
        /* verilator public_flat_rd */,
    ...
    input wire line_valid_q [0:LINE_DEPTH-1]
        /* verilator public_flat_rd */,
    input wire [1:0] line_sector_valid_q [0:LINE_DEPTH-1]
        /* verilator public_flat_rd */,
