...
module openrv64_dispatch_3p_tomasulo #(
    ...
    input  wire [`OPENRV64_INSTR_ID_WIDTH-1:0] prediction_pending_id_i,
    input  wire [RETIRE_SLOT_WIDTH-1:0] prediction_pending_slot_i,
    ...
    openrv64_dispatch_window_3p #(
        ...
        .prediction_pending_valid_i(prediction_pending_valid_i),
        .prediction_pending_id_i(prediction_pending_id_i),
        .prediction_pending_slot_i(prediction_pending_slot_i),
