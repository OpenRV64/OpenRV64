# `openrv64_exec_pipe_ex1` FPGA synthesis history
...
<!-- module-statistics-entry:start id=fpga-xc7k480t-module-stats-20260827T032508Z:openrv64_exec_pipe_ex1 -->
...
| RTL source | `rtl/core/exec/exec_pipe_ex1.v` |
...
| Elapsed | 21.6 s |
| Build log | `build/fpga/xc7k480t/module-stats/exec_pipe_ex1/yosys.log` |

### Effective parameters

| Parameter | Value |
|---|---:|
| `ENABLE_LOCAL_FORWARDING` | 0 |
| `PRODUCER_TAG_WIDTH` | 10 |
| `RETIRE_SLOT_WIDTH` | 5 |
...
| Metric | Count |
|---|---:|
| Estimated logic cells | 3,018 |
| LUT primitives | 3,965 |
| Flip-flops | 947 |
| Latches | 0 |
| CARRY4 | 84 |
| MUXF7/8/9 | 584 |
...
- Longest mapped topological path: **35 netlist cells** (`ltp -noff`).
...
- Total Yosys warnings: **3402**.

<!-- module-statistics-entry:end id=fpga-xc7k480t-module-stats-20260827T032508Z:openrv64_exec_pipe_ex1 -->
<!-- module-statistics-entry:start id=fpga-xc7k480t-module-stats-20260827T000819Z:openrv64_exec_pipe_ex1 -->
...
| Metric | Count |
|---|---:|
| Estimated logic cells | 3,093 |
| LUT primitives | 4,171 |
| Flip-flops | 947 |
| Latches | 0 |
| CARRY4 | 84 |
| MUXF7/8/9 | 734 |
...
- Longest mapped topological path: **32 netlist cells** (`ltp -noff`).
- Physical delay, WNS, and Fmax: **not measured**. These require part-specific implementation and are not inferable from topological depth.
- Logic-loop warnings: **0**; ABC loop cuts: **0**.
- Total Yosys warnings: **3157**.

<!-- module-statistics-entry:end id=fpga-xc7k480t-module-stats-20260827T000819Z:openrv64_exec_pipe_ex1 -->
