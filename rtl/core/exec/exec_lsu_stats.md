...
<!-- module-statistics-entry:start id=fpga-xc7k480t-module-stats-20260827T032508Z:openrv64_exec_lsu -->
...
| Metric | Count |
|---|---:|
| Estimated logic cells | 6,627 |
| LUT primitives | 8,651 |
| Flip-flops | 4,213 |
| Latches | 0 |
| CARRY4 | 437 |
| MUXF7/8/9 | 296 |
...
- Longest mapped topological path: **535 netlist cells** (`ltp -noff`).
...
- Total Yosys warnings: **81921**.

<!-- module-statistics-entry:end id=fpga-xc7k480t-module-stats-20260827T032508Z:openrv64_exec_lsu -->
