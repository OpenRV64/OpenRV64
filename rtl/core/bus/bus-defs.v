...
`ifndef OPENRV64_LSU_XLATE_GENERATION_WIDTH
`define OPENRV64_LSU_XLATE_GENERATION_WIDTH 4
`endif

`ifndef OPENRV64_LSU_XLATE_TAG_WIDTH
`define OPENRV64_LSU_XLATE_TAG_WIDTH \
    (`OPENRV64_LSU_TAG_WIDTH + `OPENRV64_LSU_XLATE_GENERATION_WIDTH)
`endif
