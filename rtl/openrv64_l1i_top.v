...
// Standalone 256-bit frontend boundary for the native-ICX L1 instruction
...
module openrv64_l1i_top #(
    ...
    openrv64_l1i_icx #(
        ...
        .req_priv_i(current_priv_i),
        .req_vm_mode_i(current_vm_mode_i),
        .req_asid_i(current_asid_i),
        .req_root_ppn_i(current_root_ppn_i),
        .req_sum_i(current_sum_i),
        .req_mxr_i(current_mxr_i),
