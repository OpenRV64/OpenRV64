...
XC7K480T_3P_RETIRE_DEPTH ?= 32
XC7K480T_3P_ISSUE_WINDOW_DEPTH ?= $(XC7K480T_3P_RETIRE_DEPTH)
XC7K480T_3P_PHYS_REG_COUNT ?= 31
XC7K480T_3P_RENAME_MODE ?= 0
XC7K480T_3P_BANKED_GPR ?= 0
XC7K480T_3P_FPGA_GPR_LUTRAM ?= 0
XC7K480T_3P_ISSUE_WINDOW ?= 1
XC7K480T_3P_SPECULATION_WINDOW ?= 1
XC7K480T_3P_BRANCH_COMPLETION_FORWARD_MASK ?= 1
XC7K480T_3P_RELAX_WAW ?= 1
XC7K480T_3P_ENABLE_L1I ?= 1
XC7K480T_3P_ENABLE_L1D ?= 1
XC7K480T_3P_NO_TIMING_DRIVEN ?= 0
XC7K480T_3P_L1D_RETIRED_STORE_MSHR_CANONICAL ?= 0
...
XC7K480T_3P_HIERARCHICAL_UTILIZATION_REPORT := \
	$(XC7K480T_3P_OUTPUT_DIR)/utilization_hierarchical.rpt
XC7K480T_3P_TIMING_REPORT := $(XC7K480T_3P_OUTPUT_DIR)/timing_synth.rpt
XC7K480T_3P_DCP := $(XC7K480T_3P_OUTPUT_DIR)/openrv64_core_3p.dcp
XC7K480T_DISPATCH_RENAME_OUTPUT_DIR ?= \
	$(XC7K480T_3P_OUTPUT_DIR)/dispatch-rename-breakdown
XC7K480T_DISPATCH_RENAME_HIERARCHY_REPORT := \
	$(XC7K480T_DISPATCH_RENAME_OUTPUT_DIR)/utilization_hierarchical_depth8.rpt
XC7K480T_DISPATCH_RENAME_CELL_INVENTORY := \
	$(XC7K480T_DISPATCH_RENAME_OUTPUT_DIR)/dispatch_rename_cells.tsv
...
XC7K480T_MODULE_STATS_PARAMETERS ?=
...
fpga-xc7k480t-3p-yosys:
	OUT_DIR='$(XC7K480T_3P_OUTPUT_DIR)' \
		...
		RETIRE_DEPTH='$(XC7K480T_3P_RETIRE_DEPTH)' \
		ISSUE_WINDOW_DEPTH='$(XC7K480T_3P_ISSUE_WINDOW_DEPTH)' \
		PHYS_REG_COUNT='$(XC7K480T_3P_PHYS_REG_COUNT)' \
		RENAME_MODE='$(XC7K480T_3P_RENAME_MODE)' \
		BANKED_GPR='$(XC7K480T_3P_BANKED_GPR)' \
		FPGA_GPR_LUTRAM='$(XC7K480T_3P_FPGA_GPR_LUTRAM)' \
		ISSUE_WINDOW='$(XC7K480T_3P_ISSUE_WINDOW)' \
		SPECULATION_WINDOW='$(XC7K480T_3P_SPECULATION_WINDOW)' \
		BRANCH_COMPLETION_FORWARD_MASK='$(XC7K480T_3P_BRANCH_COMPLETION_FORWARD_MASK)' \
		RELAX_WAW='$(XC7K480T_3P_RELAX_WAW)' \
		ENABLE_L1I='$(XC7K480T_3P_ENABLE_L1I)' \
		ENABLE_L1D='$(XC7K480T_3P_ENABLE_L1D)' \
		L1D_RETIRED_STORE_MSHR_CANONICAL='$(XC7K480T_3P_L1D_RETIRED_STORE_MSHR_CANONICAL)' \
...
fpga-xc7k480t-3p-vivado:
	OUT_DIR='$(XC7K480T_3P_OUTPUT_DIR)' \
		PART='$(XC7K480T_3P_PART)' \
		XDC='$(XC7K480T_3P_XDC)' \
		VIVADO='$(FPGA_VIVADO)' \
		RETIRE_DEPTH='$(XC7K480T_3P_RETIRE_DEPTH)' \
		ISSUE_WINDOW_DEPTH='$(XC7K480T_3P_ISSUE_WINDOW_DEPTH)' \
		...
		ENABLE_L1I='$(XC7K480T_3P_ENABLE_L1I)' \
		ENABLE_L1D='$(XC7K480T_3P_ENABLE_L1D)' \
		NO_TIMING_DRIVEN='$(XC7K480T_3P_NO_TIMING_DRIVEN)' \
		L1D_RETIRED_STORE_MSHR_CANONICAL='$(XC7K480T_3P_L1D_RETIRED_STORE_MSHR_CANONICAL)' \
		bash synth/fpga/xc7k480t/build_vivado_3p_core.sh

fpga-xc7k480t-3p-vivado-check:
	@test -s '$(XC7K480T_3P_DCP)'
	@test -s '$(XC7K480T_3P_UTILIZATION_REPORT)'
	@test -s '$(XC7K480T_3P_HIERARCHICAL_UTILIZATION_REPORT)'
	@test -s '$(XC7K480T_3P_TIMING_REPORT)'
	@printf 'OPENRV64 XC7K480T 3P VIVADO CHECK PASS dcp=%s report=%s\n' \
		'$(XC7K480T_3P_DCP)' '$(XC7K480T_3P_UTILIZATION_REPORT)'

fpga-xc7k480t-dispatch-rename-breakdown:
	mkdir -p '$(XC7K480T_DISPATCH_RENAME_OUTPUT_DIR)'
	$(FPGA_VIVADO) -mode batch -nojournal -nolog \
		-source synth/fpga/xc7k480t/report_dispatch_rename_breakdown.tcl \
		-tclargs '$(XC7K480T_3P_DCP)' \
		'$(XC7K480T_DISPATCH_RENAME_OUTPUT_DIR)'

fpga-xc7k480t-dispatch-rename-breakdown-check:
	@test -s '$(XC7K480T_DISPATCH_RENAME_HIERARCHY_REPORT)'
	@test -s '$(XC7K480T_DISPATCH_RENAME_CELL_INVENTORY)'
	@printf 'OPENRV64 XC7K480T DISPATCH RENAME BREAKDOWN CHECK PASS report=%s inventory=%s\n' \
		'$(XC7K480T_DISPATCH_RENAME_HIERARCHY_REPORT)' \
		'$(XC7K480T_DISPATCH_RENAME_CELL_INVENTORY)'
...
fpga-xc7k480t-module-stats:
	python3 synth/fpga/xc7k480t/build_module_stats.py \
		...
		--jobs '$(XC7K480T_MODULE_STATS_JOBS)' \
		$(if $(XC7K480T_MODULE_STATS_MODULE),--module '$(XC7K480T_MODULE_STATS_MODULE)',) \
		$(foreach parameter,$(XC7K480T_MODULE_STATS_PARAMETERS),--parameter '$(parameter)')
