...
COREMARK_BARE_ELF := sim/coremark-bare.elf
COREMARK_BARE_BIN := sim/coremark-bare.bin
COREMARK_BARE_MEMH := sim/coremark-bare.memh
COREMARK_BARE_MAP := sim/coremark-bare.map
COREMARK_BARE_DISASM := sim/coremark-bare.disasm
COREMARK_BARE_MEMH_BYTES := 0x40000
COREMARK_BARE_MEMH_WORDS := 8192
COREMARK_BARE_ITERATIONS ?= 0
COREMARK_BARE_CLOCKS_PER_SEC ?= 9216000
COREMARK_BARE_UART_ENABLE ?= 1
COREMARK_BARE_UART_DIVISOR ?= 5
COREMARK_BARE_TOTAL_DATA_SIZE ?= 2000
COREMARK_BARE_DONE_PC = $(shell $(RISCV_NM) -n $(COREMARK_BARE_ELF) | \
	awk '$$3 == "openrv64_runtime_done" { print $$1 }')
COREMARK_BARE_STATUS_PA = $(shell $(RISCV_NM) -n $(COREMARK_BARE_ELF) | \
	awk '$$3 == "coremark_status" { print $$1 }')
COREMARK_BARE_CYCLES_PA = $(shell $(RISCV_NM) -n $(COREMARK_BARE_ELF) | \
	awk '$$3 == "coremark_total_cycles" { print $$1 }')
COREMARK_BARE_SMOKE_ELF := sim/coremark-bare-smoke.elf
COREMARK_BARE_SMOKE_BIN := sim/coremark-bare-smoke.bin
COREMARK_BARE_SMOKE_MEMH := sim/coremark-bare-smoke.memh
COREMARK_BARE_SMOKE_MAP := sim/coremark-bare-smoke.map
COREMARK_BARE_SMOKE_DISASM := sim/coremark-bare-smoke.disasm
COREMARK_BARE_SMOKE_DONE_PC = $(shell $(RISCV_NM) -n \
	$(COREMARK_BARE_SMOKE_ELF) | \
	awk '$$3 == "openrv64_runtime_done" { print $$1 }')
COREMARK_BARE_RUN_ELF := sim/coremark-bare-run.elf
COREMARK_BARE_RUN_BIN := sim/coremark-bare-run.bin
COREMARK_BARE_RUN_MEMH := sim/coremark-bare-run.memh
COREMARK_BARE_RUN_MAP := sim/coremark-bare-run.map
COREMARK_BARE_RUN_DISASM := sim/coremark-bare-run.disasm
COREMARK_BARE_RUN_DONE_PC = $(shell $(RISCV_NM) -n \
	$(COREMARK_BARE_RUN_ELF) | \
	awk '$$3 == "openrv64_runtime_done" { print $$1 }')
...
CORE_3P_MAGIC_DONE_PC = $(shell $(RISCV_NM) -n $(CORE_3P_MAGIC_ELF) | \
	awk '$$3 == "openrv64_runtime_done" { print $$1 }')
...
CORE_4H_3P_BANKED_GPR ?= 0
CORE_4H_3P_FPGA_GPR_LUTRAM ?= 0
ifeq ($(filter $(CORE_4H_3P_BANKED_GPR),0 1),)
$(error CORE_4H_3P_BANKED_GPR must be 0 or 1)
endif
ifeq ($(filter $(CORE_4H_3P_FPGA_GPR_LUTRAM),0 1),)
$(error CORE_4H_3P_FPGA_GPR_LUTRAM must be 0 or 1)
endif
CORE_4H_3P_WFI_SLEEP_ENABLE ?= 1
ifeq ($(filter $(CORE_4H_3P_WFI_SLEEP_ENABLE),0 1),)
$(error CORE_4H_3P_WFI_SLEEP_ENABLE must be 0 or 1)
endif
CORE_4H_3P_WFI_CLOCK_GATING_ENABLE ?= 1
ifeq ($(filter $(CORE_4H_3P_WFI_CLOCK_GATING_ENABLE),0 1),)
$(error CORE_4H_3P_WFI_CLOCK_GATING_ENABLE must be 0 or 1)
endif
ifeq ($(filter $(CORE_4H_3P_M_MODE_PREFETCH_ENABLE),0 1),)
$(error CORE_4H_3P_M_MODE_PREFETCH_ENABLE must be 0 or 1)
endif
CORE_4H_3P_L1D_SYNC_TAG_LOOKUP ?= 1
ifeq ($(filter $(CORE_4H_3P_L1D_SYNC_TAG_LOOKUP),0 1),)
$(error CORE_4H_3P_L1D_SYNC_TAG_LOOKUP must be 0 or 1)
endif
CORE_4H_3P_L1D_SYNC_STORE_EXTENSION ?= 1
ifeq ($(filter $(CORE_4H_3P_L1D_SYNC_STORE_EXTENSION),0 1),)
$(error CORE_4H_3P_L1D_SYNC_STORE_EXTENSION must be 0 or 1)
endif
...
CORE_4H_3P_WFI_SLEEP_SUFFIX := \
	$(if $(filter 0,$(CORE_4H_3P_WFI_SLEEP_ENABLE)),-wfi0,)
CORE_4H_3P_VERILATOR_DIR := \
	build/verilator/core-4h-3p-t$(CORE_4H_3P_VERILATOR_THREADS)-bg$(CORE_4H_3P_BANKED_GPR)-lut$(CORE_4H_3P_FPGA_GPR_LUTRAM)-pf$(CORE_4H_3P_L1D_PREFETCH_ENABLE)-mpf$(CORE_4H_3P_M_MODE_PREFETCH_ENABLE)-wg$(CORE_4H_3P_WFI_CLOCK_GATING_ENABLE)$(CORE_4H_3P_WFI_SLEEP_SUFFIX)-st$(CORE_4H_3P_L1D_SYNC_TAG_LOOKUP)-se$(CORE_4H_3P_L1D_SYNC_STORE_EXTENSION)-fack$(CORE_4H_3P_FENCE_L2_ACK_ENABLE)-scx$(CORE_4H_3P_SC_EXCLUSIVE_RETAIN_ENABLE)-ddr$(CORE_4H_3P_DDR3_ENABLE)
...
CORE_3P_MAGIC_CONFIDENCE_GATE ?= 1
...
CORE_3P_ICX_L2_ORACLE_BRANCHES ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ORACLE_BRANCHES),0 1),)
$(error CORE_3P_ICX_L2_ORACLE_BRANCHES must be 0 or 1)
endif
CORE_3P_ICX_L2_BANKED_GPR ?= 0
CORE_3P_ICX_L2_FPGA_GPR_LUTRAM ?= 0
CORE_3P_ICX_L2_BANKED_GPR_READ_PORTS_PER_BANK ?= 2
CORE_3P_ICX_L2_BANKED_GPR_NUM_BANKS ?= 4
ifeq ($(filter $(CORE_3P_ICX_L2_BANKED_GPR),0 1),)
$(error CORE_3P_ICX_L2_BANKED_GPR must be 0 or 1)
endif
ifeq ($(filter $(CORE_3P_ICX_L2_FPGA_GPR_LUTRAM),0 1),)
$(error CORE_3P_ICX_L2_FPGA_GPR_LUTRAM must be 0 or 1)
endif
ifeq ($(filter $(CORE_3P_ICX_L2_BANKED_GPR_READ_PORTS_PER_BANK),1 2 3 4),)
$(error CORE_3P_ICX_L2_BANKED_GPR_READ_PORTS_PER_BANK must be 1, 2, 3, or 4)
endif
ifeq ($(filter $(CORE_3P_ICX_L2_BANKED_GPR_NUM_BANKS),2 4 8 16 32),)
$(error CORE_3P_ICX_L2_BANKED_GPR_NUM_BANKS must be 2, 4, 8, 16, or 32)
endif
CORE_3P_ICX_L2_RESULT_READY_CONTROL_RELEASE ?= 1
ifeq ($(filter $(CORE_3P_ICX_L2_RESULT_READY_CONTROL_RELEASE),0 1),)
$(error CORE_3P_ICX_L2_RESULT_READY_CONTROL_RELEASE must be 0 or 1)
endif
CORE_3P_ICX_L2_RETIRE_DEPTH ?= 16
CORE_3P_ICX_L2_ISSUE_WINDOW_DEPTH ?= $(CORE_3P_ICX_L2_RETIRE_DEPTH)
CORE_3P_ICX_L2_PHYS_REG_COUNT ?= 31
CORE_3P_ICX_L2_RENAME_MODE ?= 0
CORE_3P_ICX_L2_ENABLE_ALU2 ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_ALU2),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_ALU2 must be 0 or 1)
endif
CORE_3P_ICX_L2_ENABLE_ALU_CHAINING ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_ALU_CHAINING),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_ALU_CHAINING must be 0 or 1)
endif
CORE_3P_ICX_L2_ENABLE_LOAD_CONFLICT_RECORD ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_LOAD_CONFLICT_RECORD),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_LOAD_CONFLICT_RECORD must be 0 or 1)
endif
CORE_3P_ICX_L2_ENABLE_DECODE_FUSION ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_DECODE_FUSION),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_DECODE_FUSION must be 0 or 1)
endif
CORE_3P_ICX_L2_POSTED_STORES ?= 1
CORE_3P_ICX_L2_STORE_QUEUE_DEPTH ?= 4
CORE_3P_ICX_L2_LOAD_QUEUE_DEPTH ?= 4
CORE_3P_ICX_L2_LSU_TAG_WIDTH ?= 3
CORE_3P_ICX_L2_LSU_OUTSTANDING ?= 8
...
CORE_3P_ICX_L2_M_MODE_PREFETCH_ENABLE ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_M_MODE_PREFETCH_ENABLE),0 1),)
$(error CORE_3P_ICX_L2_M_MODE_PREFETCH_ENABLE must be 0 or 1)
endif
CORE_3P_ICX_L2_RAM_BYTES ?= 16777216
CORE_3P_ICX_L2_L1I_BYTES ?= 16384
CORE_3P_ICX_L2_L1I_FETCH_WIDTH ?= 512
ifeq ($(filter $(CORE_3P_ICX_L2_L1I_FETCH_WIDTH),256 512),)
$(error CORE_3P_ICX_L2_L1I_FETCH_WIDTH must be 256 or 512)
endif
CORE_3P_ICX_L2_L1D_BYTES ?= 16384
CORE_3P_ICX_L2_L1D_SYNC_TAG_LOOKUP ?= 1
CORE_3P_ICX_L2_L1D_SYNC_STORE_EXTENSION ?= 1
CORE_3P_ICX_L2_LSU_PAGE_SCREEN ?= 1
...
ifeq ($(filter $(CORE_3P_ICX_L2_LSU_PAGE_SCREEN),0 1),)
$(error CORE_3P_ICX_L2_LSU_PAGE_SCREEN must be 0 or 1)
endif
...
CORE_3P_ICX_L2_ENABLE_PIPELINE_STATE_TRACE ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_PIPELINE_STATE_TRACE),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_PIPELINE_STATE_TRACE must be 0 or 1)
endif
...
CORE_3P_ICX_L2_ENABLE_FRONTEND_TRACE ?= 0
ifeq ($(filter $(CORE_3P_ICX_L2_ENABLE_FRONTEND_TRACE),0 1),)
$(error CORE_3P_ICX_L2_ENABLE_FRONTEND_TRACE must be 0 or 1)
endif
CORE_3P_ICX_L2_FRONTEND_TRACE ?=
CORE_3P_ICX_L2_FRONTEND_TRACE_BZIP2 ?=
CORE_3P_ICX_L2_FRONTEND_TRACE_REPORT ?=
# Frontend trace uses the same marker/absolute-cycle selection convention as
# the resident-instruction trace, but it is an independent one-row-per-cycle
# artifact and does not require dynamic instruction IDs.
CORE_3P_ICX_L2_FRONTEND_TRACE_START ?= -1
CORE_3P_ICX_L2_FRONTEND_TRACE_CYCLES ?= 0
CORE_3P_ICX_L2_FRONTEND_TRACE_FLUSH ?= 1024
...
CORE_3P_ICX_L2_VERILATOR_DIR := \
	$(CORE_3P_ICX_L2_VERILATOR_DIR)/oracle
endif
ifeq ($(CORE_3P_ICX_L2_ENABLE_ALU2),1)
CORE_3P_ICX_L2_VERILATOR_DIR := \
	$(CORE_3P_ICX_L2_VERILATOR_DIR)/alu2
endif
...
# Linux SMP/held-platform default. Directed tests and controlled performance
# experiments may still pin a different depth explicitly.
OPENSBI_4H_HELD_RETIRE_DEPTH ?= 32
OPENSBI_4H_HELD_ISSUE_WINDOW_DEPTH ?= $(OPENSBI_4H_HELD_RETIRE_DEPTH)
OPENSBI_4H_HELD_PHYS_REG_COUNT ?= 31
OPENSBI_4H_HELD_RENAME_MODE ?= 0
OPENSBI_4H_HELD_HARNESS ?= 3p
ifeq ($(filter $(OPENSBI_4H_HELD_HARNESS),3p tomasulo),)
$(error OPENSBI_4H_HELD_HARNESS must be 3p or tomasulo)
endif
ifeq ($(OPENSBI_4H_HELD_HARNESS),tomasulo)
OPENSBI_4H_HELD_HARNESS_SOURCE := tb/tb_4h_3p_tomasulo.sv
OPENSBI_4H_HELD_HARNESS_SUFFIX := -tomasulo
else
OPENSBI_4H_HELD_HARNESS_SOURCE := tb/tb_4h_3p.sv
OPENSBI_4H_HELD_HARNESS_SUFFIX :=
endif
OPENSBI_4H_BANKED_GPR ?= 0
OPENSBI_4H_FPGA_GPR_LUTRAM ?= 0
OPENSBI_4H_COMPLETION_FORWARD_MASK ?= 0
OPENSBI_4H_BRANCH_COMPLETION_FORWARD_MASK ?= \
	$(if $(filter 0,$(OPENSBI_4H_BANKED_GPR)),1,0)
OPENSBI_4H_RELAX_WAW ?= \
	$(if $(filter 0,$(OPENSBI_4H_BANKED_GPR)),1,0)
OPENSBI_4H_ENABLE_ISSUE_WINDOW ?= \
	$(if $(filter 0,$(OPENSBI_4H_BANKED_GPR)),1,0)
OPENSBI_4H_ENABLE_SPECULATION_WINDOW ?= \
	$(if $(filter 0,$(OPENSBI_4H_BANKED_GPR)),1,0)
ifeq ($(filter $(OPENSBI_4H_BANKED_GPR),0 1),)
$(error OPENSBI_4H_BANKED_GPR must be 0 or 1)
endif
ifeq ($(filter $(OPENSBI_4H_FPGA_GPR_LUTRAM),0 1),)
$(error OPENSBI_4H_FPGA_GPR_LUTRAM must be 0 or 1)
endif
OPENSBI_4H_FETCH_CAROUSEL ?= 1
OPENSBI_4H_FETCH_ALT_LOOKASIDE ?= 3
OPENSBI_4H_FETCH_ALT_CONFIDENCE_GATE ?= 1
OPENSBI_4H_FETCH_ALT_PAIR_STACK_DEPTH ?= 2
OPENSBI_4H_FETCH_PAGE_SCREEN_ENTRIES ?= 4
OPENSBI_4H_LSU_PAGE_SCREEN_ENTRIES ?= 4
ifeq ($(filter $(OPENSBI_4H_FETCH_PAGE_SCREEN_ENTRIES),2 4 8 16 32),)
$(error OPENSBI_4H_FETCH_PAGE_SCREEN_ENTRIES must be a supported power of two)
endif
ifeq ($(filter $(OPENSBI_4H_LSU_PAGE_SCREEN_ENTRIES),2 4 8 16 32),)
$(error OPENSBI_4H_LSU_PAGE_SCREEN_ENTRIES must be a supported power of two)
endif
OPENSBI_4H_WFI_SLEEP_ENABLE ?= 1
ifeq ($(filter $(OPENSBI_4H_WFI_SLEEP_ENABLE),0 1),)
$(error OPENSBI_4H_WFI_SLEEP_ENABLE must be 0 or 1)
endif
OPENSBI_4H_WFI_CLOCK_GATING_ENABLE ?= 1
ifeq ($(filter $(OPENSBI_4H_WFI_CLOCK_GATING_ENABLE),0 1),)
$(error OPENSBI_4H_WFI_CLOCK_GATING_ENABLE must be 0 or 1)
endif
...
OPENSBI_4H_HELD_VERILATOR_DIR := \
	build/verilator/opensbi-4h-held$(OPENSBI_4H_HELD_HARNESS_SUFFIX)-bg$(OPENSBI_4H_BANKED_GPR)-lut$(OPENSBI_4H_FPGA_GPR_LUTRAM)-zbb$(OPENSBI_3P_ENABLE_ZBB)-wfi$(OPENSBI_4H_WFI_SLEEP_ENABLE)-wg$(OPENSBI_4H_WFI_CLOCK_GATING_ENABLE)-fack$(OPENSBI_4H_FENCE_L2_ACK_ENABLE)-ci$(OPENSBI_4H_HELD_CORE_INSTANCES)-rd$(OPENSBI_4H_HELD_RETIRE_DEPTH)-sd$(OPENSBI_4H_HELD_ISSUE_WINDOW_DEPTH)-prf$(OPENSBI_4H_HELD_PHYS_REG_COUNT)-rn$(OPENSBI_4H_HELD_RENAME_MODE)-cf$(OPENSBI_4H_COMPLETION_FORWARD_MASK)-bf$(OPENSBI_4H_BRANCH_COMPLETION_FORWARD_MASK)-rw$(OPENSBI_4H_RELAX_WAW)-iw$(OPENSBI_4H_ENABLE_ISSUE_WINDOW)-sw$(OPENSBI_4H_ENABLE_SPECULATION_WINDOW)-car$(OPENSBI_4H_FETCH_CAROUSEL)-fa$(OPENSBI_4H_FETCH_ALT_LOOKASIDE)-fc$(OPENSBI_4H_FETCH_ALT_CONFIDENCE_GATE)-fps$(OPENSBI_4H_FETCH_ALT_PAIR_STACK_DEPTH)-fs$(OPENSBI_4H_FETCH_PAGE_SCREEN_ENTRIES)-ls$(OPENSBI_4H_LSU_PAGE_SCREEN_ENTRIES)-t$(OPENSBI_4H_HELD_VERILATOR_THREADS)-pf$(CORE_4H_3P_L1D_PREFETCH_ENABLE)-mpf$(CORE_4H_3P_M_MODE_PREFETCH_ENABLE)-st$(CORE_4H_3P_L1D_SYNC_TAG_LOOKUP)-se$(CORE_4H_3P_L1D_SYNC_STORE_EXTENSION)-mem$(OPENSBI_4H_HELD_MEMORY_BYTES)-fdt$(OPENSBI_4H_HELD_FDT_BASE)-ddr3$(OPENSBI_4H_DDR3_ENABLE)x$(OPENSBI_4H_DDR3_READ_QUEUE_DEPTH)x$(OPENSBI_4H_DDR3_WRITE_QUEUE_DEPTH)x$(OPENSBI_4H_DDR3_COMMAND_QUEUE_DEPTH)xbt$(OPENSBI_4H_DDR3_MAX_BURST_TRAIN_BURSTS)xsw$(OPENSBI_4H_DDR3_BANK_ROW_SWIZZLE)-gb$(OPENSBI_4H_GENBUS_READ_DEPTH)x$(OPENSBI_4H_GENBUS_WRITE_DEPTH)
...
OPENSBI_4H_LINUX_IMAGE ?= sw/linux/kernels/Image.zbb2
...
OPENSBI_SMP_LINUX_IMAGE ?= sw/linux/kernels/Image.zbb2
...
# Keep the standalone OpenSBI/Linux platform consistent with the SMP harness.
...
OPENSBI_3P_PLATFORM_FETCH_ALT_CONFIDENCE_GATE ?= 1
...
COREMARK_BARE_CFLAGS := -march=rv64im_zicsr -mabi=lp64 -mcmodel=medany \
	...
	-fno-stack-protector -fno-asynchronous-unwind-tables \
	-ffunction-sections -fdata-sections
COREMARK_BARE_PASS := 00000000434d4f4b
...
AXI_3P_FETCH_ALT_CONFIDENCE_GATE ?= 1
