...
CORE_1H_COHERENT_3P_VERILATOR_DIR := \
	build/verilator/core-1h-coherent-3p-ddr3-t$(CORE_1H_COHERENT_3P_VERILATOR_THREADS)-pf$(CORE_4H_3P_L1D_PREFETCH_ENABLE)
...
OPENSBI_3P_VERILATOR_DIR := build/verilator/opensbi-3p-axi-zicclsm$(OPENSBI_3P_ENABLE_ZICCLSM)-iw$(OPENSBI_3P_ISSUE_WINDOW)-sw$(OPENSBI_3P_SPECULATION_WINDOW)
