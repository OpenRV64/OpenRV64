...
sim-fence-sv39-order: $(FENCE_CORRECT_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		...
		CORE_3P_CCX_L2_L1D_PREFETCH_ENABLE=0 \
		CORE_3P_CCX_L2_DDR3=0 \
		CORE_3P_CCX_L2_MEMH=$(FENCE_CORRECT_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(FENCE_MEMH_WORDS) \
		CORE_3P_CCX_L2_MAX_CYCLES=$(FENCE_MAX_CYCLES) \
		CORE_3P_CCX_L2_SPEC_LOAD_BASE=1073741824 \
		CORE_3P_CCX_L2_SPEC_LOAD_SIZE=262144 \
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(FENCE_CORRECT_PASS) +done_pc=$(FENCE_CORRECT_DONE) +require_sv39 +fence_check"
...
sim-fence-sv39-case: $(FENCE_CASE_MEMH) $(FENCE_CASE_DISASM)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		...
		CORE_3P_CCX_L2_L1D_PREFETCH_ENABLE=0 \
		CORE_3P_CCX_L2_DDR3=0 \
		CORE_3P_CCX_L2_MEMH=$(FENCE_CASE_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(FENCE_MEMH_WORDS) \
		CORE_3P_CCX_L2_MAX_CYCLES=$(FENCE_MAX_CYCLES) \
		CORE_3P_CCX_L2_SPEC_LOAD_BASE=1073741824 \
		CORE_3P_CCX_L2_SPEC_LOAD_SIZE=266240 \
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(FENCE_CORRECT_PASS) +done_pc=$(FENCE_CASE_DONE) +fence_sv39_active +fence_check +fence_case=$(FENCE_CASE)"
...
sim-atomic-sv39: $(ATOMIC_SV39_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		...
		CORE_3P_CCX_L2_L1D_PREFETCH_ENABLE=0 \
		CORE_3P_CCX_L2_DDR3=0 \
		CORE_3P_CCX_L2_MEMH=$(ATOMIC_SV39_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(FENCE_MEMH_WORDS) \
		CORE_3P_CCX_L2_MAX_CYCLES=$(FENCE_MAX_CYCLES) \
		CORE_3P_CCX_L2_SPEC_LOAD_BASE=1073741824 \
		CORE_3P_CCX_L2_SPEC_LOAD_SIZE=262144 \
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(ATOMIC_SOC_PASS) +done_pc=$(ATOMIC_SV39_DONE) +require_sv39"
...
bench-fence-sv39: $(FENCE_BENCH_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		...
		CORE_3P_CCX_L2_L1D_PREFETCH_ENABLE=0 \
		CORE_3P_CCX_L2_DDR3=0 \
		CORE_3P_CCX_L2_MEMH=$(FENCE_BENCH_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(FENCE_MEMH_WORDS) \
		CORE_3P_CCX_L2_MAX_CYCLES=$(FENCE_MAX_CYCLES) \
		CORE_3P_CCX_L2_SPEC_LOAD_BASE=1073741824 \
		CORE_3P_CCX_L2_SPEC_LOAD_SIZE=262144 \
		CORE_3P_CCX_L2_ARGS="+done_pc=$(FENCE_BENCH_DONE) +require_sv39 +report_a_regs"
