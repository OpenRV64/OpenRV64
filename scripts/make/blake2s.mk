...
sim-blake2s: $(BLAKE2S_MEMH)
	$(MAKE) sim-core-3p-ccx-l2 \
		CORE_3P_CCX_L2_MEMH=$(BLAKE2S_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(BLAKE2S_MEMH_WORDS) \
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(BLAKE2S_PASS) +progress_cycles=$(BLAKE2S_PROGRESS_CYCLES) $(BLAKE2S_REQUIRE_ARGS)" \
		CORE_3P_CCX_L2_MAX_CYCLES=$(BLAKE2S_MAX_CYCLES) \
		...
		CORE_3P_CCX_L2_DDR3=$(BLAKE2S_DDR3) \
		CORE_3P_CCX_L2_DDR3_BANK_ROW_SWIZZLE=$(BLAKE2S_DDR3_BANK_ROW_SWIZZLE) \
		CORE_3P_CCX_L2_MEMORY_TIMING_MODEL=$(BLAKE2S_MEMORY_TIMING_MODEL)
...
bench-blake2s: $(BLAKE2S_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		CORE_3P_CCX_L2_MEMH=$(BLAKE2S_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(BLAKE2S_MEMH_WORDS) \
		CORE_3P_CCX_L2_ARGS="+done_pc=$(BLAKE2S_MEASURE_END) +report_blake2s +progress_cycles=$(BLAKE2S_PROGRESS_CYCLES) $(BLAKE2S_REQUIRE_ARGS)" \
		CORE_3P_CCX_L2_MAX_CYCLES=$(BLAKE2S_MAX_CYCLES) \
		CORE_3P_CCX_L2_RAM_BYTES=16777216 \
		CORE_3P_CCX_L2_BP_TYPE=8 \
		CORE_3P_CCX_L2_FETCH_CAROUSEL=1 \
