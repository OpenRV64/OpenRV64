...
sim-pagefree: $(PAGEFREE_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		CORE_3P_CCX_L2_MEMH=$(PAGEFREE_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(PAGEFREE_MEMH_WORDS) \
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(PAGEFREE_PASS) +done_pc=$(PAGEFREE_DONE) +progress_cycles=$(PAGEFREE_PROGRESS_CYCLES) $(PAGEFREE_REQUIRE_ARGS)" \
		CORE_3P_CCX_L2_MAX_CYCLES=$(PAGEFREE_MAX_CYCLES) \
		CORE_3P_CCX_L2_RAM_BYTES=16777216 \
		CORE_3P_CCX_L2_BP_TYPE=8 \
		CORE_3P_CCX_L2_FETCH_CAROUSEL=1 \
		CORE_3P_CCX_L2_MODE=3 \
		CORE_3P_CCX_L2_CONFIDENCE_GATE=0 \
		CORE_3P_CCX_L2_RETIRE_DEPTH=32 \
		...
		CORE_3P_CCX_L2_L1D_PREFETCH_ENABLE=$(PAGEFREE_L1D_PREFETCH_ENABLE) \
		CORE_3P_CCX_L2_L1D_PREFETCH_MAX_DISTANCE=$(PAGEFREE_L1D_PREFETCH_MAX_DISTANCE) \
		CORE_3P_CCX_L2_L1D_PREFETCH_PAGE_GATING=$(PAGEFREE_L1D_PREFETCH_PAGE_GATING) \
		CORE_3P_CCX_L2_DDR3=$(PAGEFREE_DDR3) \
		CORE_3P_CCX_L2_MEMORY_TIMING_MODEL=$(PAGEFREE_MEMORY_TIMING_MODEL)
...
bench-pagefree: $(PAGEFREE_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		CORE_3P_CCX_L2_MEMH=$(PAGEFREE_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(PAGEFREE_MEMH_WORDS) \
		CORE_3P_CCX_L2_ARGS="+done_pc=$(PAGEFREE_MEASURE_END) +report_pagefree +progress_cycles=$(PAGEFREE_PROGRESS_CYCLES) $(PAGEFREE_REQUIRE_ARGS)" \
		CORE_3P_CCX_L2_MAX_CYCLES=$(PAGEFREE_MAX_CYCLES) \
		CORE_3P_CCX_L2_RAM_BYTES=16777216 \
		CORE_3P_CCX_L2_BP_TYPE=8 \
		CORE_3P_CCX_L2_FETCH_CAROUSEL=1 \
