...
$(error PAGEFREE_KERNEL must be core or tail)
endif
...
sim-pagefree: $(PAGEFREE_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		...
		CORE_3P_CCX_L2_ARGS="+expect_a0=$(PAGEFREE_PASS) +done_pc=$(PAGEFREE_DONE) $(PAGEFREE_REQUIRE_ARGS)" \
...
bench-pagefree: $(PAGEFREE_MEMH)
	...
	$(MAKE) sim-core-3p-ccx-l2 \
		CORE_3P_CCX_L2_MEMH=$(PAGEFREE_MEMH) \
		CORE_3P_CCX_L2_MEMH_WORDS=$(PAGEFREE_MEMH_WORDS) \
		CORE_3P_CCX_L2_ARGS="+done_pc=$(PAGEFREE_MEASURE_END) +report_pagefree $(PAGEFREE_REQUIRE_ARGS)" \
		CORE_3P_CCX_L2_MAX_CYCLES=$(PAGEFREE_MAX_CYCLES) \
		CORE_3P_CCX_L2_RAM_BYTES=16777216 \
		CORE_3P_CCX_L2_BP_TYPE=8 \
		CORE_3P_CCX_L2_FETCH_CAROUSEL=1 \
