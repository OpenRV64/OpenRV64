...
module tb_test_marker_3p;
    ...
    task automatic check_masked;
        ...
        begin
            ...
            if (marker_result[
                ...
                $fatal(1, "tagged START_TEST EBREAK was not masked");
    ...
    initial begin
        ...
        @(posedge clk);
        #1;
        if (start_test || disabled_start_test)
            $fatal(1, "ordinary EBREAK emitted START_TEST");
        ...
        #1;
        if (start_test)
            $fatal(1, "START_TEST pulse did not clear");
        ...
        $display("PASS: 3P retirement START_TEST marker");
        $finish;
    end
endmodule
