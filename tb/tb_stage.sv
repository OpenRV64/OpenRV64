...
module tb_stage;
    ...
    initial begin
        ...
        @(posedge clk);
        expect_registered(1'b1, 1'b0, 8'h00, "registered bubble clears active");
        ...
        r_flush = 1'b1;
        r_out_clear = 1'b0;
        expect_registered(1'b1, 1'b0, 8'h00, "registered flush kills output");
        @(posedge clk);
        @(negedge clk);
        r_flush = 1'b0;
        r_in_valid = 1'b0;
        r_out_clear = 1'b1;
        expect_registered(1'b1, 1'b0, 8'h00, "registered empty after flush");
