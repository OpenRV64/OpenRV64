...
module tb_exec_lsu_rv64i;
    ...
    initial begin
        ...
        check(`RV64_LSU_OP_SB,
              ...
              1'b1, 1'b1, 64'h0000_0000_0000_1005, 64'h0000_aa00_0000_0000, 8'h20, "sb");

        check(`RV64_LSU_OP_SH,
              64'h0000_0000_0000_1004, 64'h0, 64'h0000_0000_0000_beef, 64'h0,
              1'b1, 1'b0, 1'b0, 64'h0,
              1'b1, 1'b1, 64'h0000_0000_0000_1004, 64'h0000_beef_0000_0000, 8'h30, "sh");

        check(`RV64_LSU_OP_SW,
              64'h0000_0000_0000_1004, 64'h0, 64'h0000_0000_dead_beef, 64'h0,
              1'b1, 1'b0, 1'b0, 64'h0,
              1'b1, 1'b1, 64'h0000_0000_0000_1004, 64'hdead_beef_0000_0000, 8'hf0, "sw");
        ...
        check(`RV64_LSU_OP_LH,
              ...
              1'b0, 1'b0, 64'h0000_0000_0000_1001, 64'h0, 8'h00, "misaligned lh");

        check(`RV64_LSU_OP_SW,
              64'h0000_0000_0000_1002, 64'h0, 64'h0000_0000_dead_beef, 64'h0,
              1'b1, 1'b0, 1'b1, 64'h0,
              1'b0, 1'b0, 64'h0000_0000_0000_1002, 64'h0, 8'h00, "misaligned sw");
